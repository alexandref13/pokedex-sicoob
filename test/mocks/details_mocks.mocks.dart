...
// in pokedex_sicoob/test/mocks/details_mocks.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockDetailsRepository extends _i1.Mock implements _i8.DetailsRepository {
  MockDetailsRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i3.PokemonDetailsModel> getPokemonsDetails(
          {required String? id}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPokemonsDetails,
...
/// A class which mocks [GetPokemonDetailsUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetPokemonDetailsUsecase extends _i1.Mock
    implements _i9.GetPokemonDetailsUsecase {
  MockGetPokemonDetailsUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i3.PokemonDetailsModel> getPokemonDetails(
          {required String? id}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPokemonDetails,
